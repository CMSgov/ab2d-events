CREATE SEQUENCE IF NOT EXISTS event.event_api_request_id_seq;
CREATE SEQUENCE IF NOT EXISTS event.event_api_response_id_seq;
CREATE SEQUENCE IF NOT EXISTS event.event_bene_reload_id_seq;
CREATE SEQUENCE IF NOT EXISTS event.event_bene_search_id_seq;
CREATE SEQUENCE IF NOT EXISTS event.event_error_id_seq;
CREATE SEQUENCE IF NOT EXISTS event.event_file_id_seq;
CREATE SEQUENCE IF NOT EXISTS event.event_job_status_change_id_seq;
...
ALTER TABLE event.event_api_response ALTER COLUMN id SET DEFAULT nextval('event_api_response_id_seq');
